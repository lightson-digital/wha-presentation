...
1. **4th-generation family farm, 100+ years, 140 acres, named family** (Matsuda + Fukuyama), positions the brand against Dole Plantation (corporate, ticketed) and against the mac-nut-outlet model (retail-first).
2. **Farm-to-table café on the same property**: competitors are tour-only or retail-only; Kahuku Farms keeps you for lunch, which raises per-visit revenue and gives the brand a memorable food hook (banana bread, mochi, açaí bowl).
